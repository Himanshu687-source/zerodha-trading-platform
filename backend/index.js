...
const {verfiyToken} = require('./middleware/middleware');
const { signUpController, signInController, getUser } = require('./model/UserModel');
...
app.get("/api/auth/user", verfiyToken, getUser);
